...
model.fit([input_sequences, target_sequences], decoder_target_data, batch_size=2,
...
return_state=True)(dec_emb2, initial_state=[dec_state_input_h, dec_state_input_c])
...
decoder_model = Model([decoder_inputs, enc_output_input, dec_state_input_h,
dec_state_input_c], [dec_outputs2, state_h2, state_c2])
